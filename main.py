...
def get_weather():
    try:
        ...
        # Weather
        api_key = "70356b7408ec20c6ff02751b90eecec4"
...
search_icon_button = tk.Button(root, image=search_icon, bg="#404040",
                               border=0, cursor="hand2", command=get_weather)
...
# Labels
label1 = tk.Label(root, text="WIND", font=("Helvetiva", 15, "bold"),
                  fg="white", bg="#1ab5ef")
label1.place(x=120, y=400)

label2 = tk.Label(root, text="HUMIDITY", font=("Helvetiva", 15, "bold"),
                  fg="white", bg="#1ab5ef")
label2.place(x=280, y=400)

label3 = tk.Label(root, text="DESCRIPTION", font=("Helvetiva", 15, "bold"),
                  fg="white", bg="#1ab5ef")
label3.place(x=450, y=400)

label4 = tk.Label(root, text="PRESSURE", font=("Helvetiva", 15, "bold"),
                  fg="white", bg="#1ab5ef")
...
root.mainloop()   # keep open the window that created
